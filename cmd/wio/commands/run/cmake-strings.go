...
const atmelavrHeaderOnlyString = `add_library({{DEPENDENCY_NAME}} INTERFACE)
...
const atmelavrNonHeaderOnlyString = `file(GLOB_RECURSE SRC_FILES_{{DEPENDENCY_NAME}} "{{DEPENDENCY_PATH}}/src/*.cpp" "{{DEPENDENCY_PATH}}/src/*.cc" "{{DEPENDENCY_PATH}}/src/*.c")
...
const nativeHeaderOnlyString = `add_library({{DEPENDENCY_NAME}} INTERFACE)
...
const nativeNonHeaderOnlyString = `file(GLOB_RECURSE SRC_FILES__{{DEPENDENCY_NAME}} "{{DEPENDENCY_PATH}}/src/*.cpp" "{{DEPENDENCY_PATH}}/src/*.cc" "{{DEPENDENCY_PATH}}/src/*.c")
